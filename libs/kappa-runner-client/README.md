...
If the OpenAPI document is large, imports in kappa_runner_client.apis and kappa_runner_client.models may fail with a
RecursionError indicating the maximum recursion limit has been exceeded. In that case, there are a couple of solutions:

Solution 1:
Use specific imports for apis and models like:
- `from kappa_runner_client.apis.default_api import DefaultApi`
...
import kappa_runner_client
from kappa_runner_client.apis import *
from kappa_runner_client.models import *
```
