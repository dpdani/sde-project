...
from kappa_runner_client import api_client, exceptions
...
# body param
SchemaForRequestBodyApplicationJson = FunctionToLoad


request_body_function_to_load = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _load_function_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_function_to_load.serialize(body, content_type)
...
class LoadFunction(BaseApi):
    ...
    def load_function(
        ...
        return self._load_function_oapg(
            body=body,
