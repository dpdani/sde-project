...
with kappa_fn_code_client.ApiClient(configuration) as api_client:
    ...
    code_id = "code_id_example" # str | 
body = "body_example" # str | 

    try:
        # Create Code
        api_response = api_instance.create_code(code_idbody)
        pprint(api_response)
...
If the OpenAPI document is large, imports in kappa_fn_code_client.apis and kappa_fn_code_client.models may fail with a
RecursionError indicating the maximum recursion limit has been exceeded. In that case, there are a couple of solutions:

Solution 1:
Use specific imports for apis and models like:
- `from kappa_fn_code_client.apis.default_api import DefaultApi`
...
import kappa_fn_code_client
from kappa_fn_code_client.apis import *
from kappa_fn_code_client.models import *
```
