...
[**get_code**](#get_code) | **get** /code/{code_id}/ | Get Code
[**get_code_ids**](#get_code_ids) | **get** /code/ | Get Code Ids
...
with kappa_fn_code_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->get_code: %s\n" % e)
```
### Parameters
...
------------- | ------------- | -------------
n/a | api_client.ApiResponseWithoutDeserialization | When skip_deserialization is True this response is returned
200 | [ApiResponseFor200](#get_code.ApiResponseFor200) | Successful Response
422 | [ApiResponseFor422](#get_code.ApiResponseFor422) | Validation Error

#### get_code.ApiResponseFor200
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor200ResponseBodyApplicationJson, ] |  |
...
with kappa_fn_code_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Code Ids
        api_response = api_instance.get_code_ids()
        pprint(api_response)
    except kappa_fn_code_client.ApiException as e:
        print("Exception when calling DefaultApi->get_code_ids: %s\n" % e)
```
### Parameters
...
------------- | ------------- | -------------
n/a | api_client.ApiResponseWithoutDeserialization | When skip_deserialization is True this response is returned
200 | [ApiResponseFor200](#get_code_ids.ApiResponseFor200) | Successful Response

#### get_code_ids.ApiResponseFor200
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor200ResponseBodyApplicationJson, ] |  |
